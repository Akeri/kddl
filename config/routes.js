...
module.exports.routes = {
  ...
  '/user/:userId/player/create' : {
    controller  : "PlayerController",
    action      : 'create'
  },
  
  '/user/:userId/player/edit/:id' : {
    controller  : "PlayerController",
    action      : "edit"
  },
  
  '/user/:userId/player/update/:id' : {
    controller  : "PlayerController",
    action      : "update"
  },
  
  '/user/:userId/player/:id/turnmain' : {
    controller  : "PlayerController",
    action      : 'turnMain'
  },
  
  '/user/:userId/player/destroy/:id' : {
    controller  : "PlayerController",
    action      : 'destroy'
  },
  
  '/user/:userId/player/editarmors/:id' : {
    controller  : "PlayerController",
    action      : 'editArmors'
  },
  
  '/user/:userId/player/:playerId/armor/create' : {
    controller  : "PlayerController",
    action      : "ownArmor"
  },
  
  '/user/:userId/player/:playerId/armor/update/:id' : {
    controller  : "PlayerController",
    action      : "updateOwnedArmor"
  },
  
  '/user/:userId/player/:playerId/armor/destroy/:id' : {
    controller  : "PlayerController",
    action      : "deleteOwnedArmor"
  },
